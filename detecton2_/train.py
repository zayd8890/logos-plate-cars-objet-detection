...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-dir', default=r"C:\\Users\\DELL\\Downloads\\train-object-detector-detectron2\\FINAL_DATASET.v1i.yolov8")
    ...
    parser.add_argument('--model', default=r"COCO-Detection\faster_rcnn_R_50_FPN_3x")
